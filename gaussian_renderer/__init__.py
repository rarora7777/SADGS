...
from diff_gaussian_rasterization_structgs import GaussianRasterizationSettings, GaussianRasterizer

def render_structgs(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, mult, scaling_modifier = 1.0, override_color = None, get_flag=None, metric_map = None, compute_extra=False):
    """
    Render the scene. 
